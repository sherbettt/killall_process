...
Если получаете ошибку в момент выполения плейбука, то сначала воспользуйтесь плейбуком из проекта [create_ssh_users](https://gitlab.runtel.org/runtel/create_ssh_users), т.к. именно в нём создаются пользователя и ключи SSH. 
